...
import HeroFurnace from '../components/furnace/HeroFurnace';
import AvoidHeadachesFurnace from '../components/furnace/AvoidHeadachesFurnace';
import { MultiColumnSectionFurnace } from '../components/furnace/MultiColumnSectionFurnace';
import SecondaryHeroFurnace from '../components/furnace/SecondaryHeroFurnace';
...
const FurnaceService: React.FC<LandingPageProps> = ({ contactFormEmbed }) => {
  return (
    <>
       <Helmet>
         <script>
    ...
    'phone_conversion_number': '(385) 200-2604'
      ...
      <HeroFurnace contactFormEmbed={contactFormEmbed} />
      <div className="md:mt-[-50px]  relative z-100">
      <MultiColumnSectionFurnace />
      </div>
      <AvoidHeadachesFurnace contactFormEmbed={contactFormEmbed} />
      
      <SecondaryHeroFurnace />
      ...
      <div className="bg-[linear-gradient(to_bottom,rgba(255,255,255,0)_0%,rgba(255,255,255,1)_100%),url('https://res.cloudinary.com/dwe4p22ut/image/upload/v1747853406/toparticlewrapperbg_wyeckj.webp')] bg-cover bg-center bg-no-repeat">
        <TestimonialsSectionFurnace />
        <ProcessSectionFurnace />
