...
const SecondaryHeroFurnace: React.FC = () => {
...
<div className="relative z-20 ">
  <div className="mx-auto ">
    <div className="relative">
      <img
        src="/worker-refilling-hvac.webp"
      ...
      <div className="absolute bottom-8 left-4 right-4 md:left-1/2 md:transform md:-translate-x-1/2 md:max-w-4xl bg-white/60 p-6 rounded-lg backdrop-blur-sm">
        ...
        <div className="text-left md:text-center mb-12 mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-blue-primary mb-4">Limited-Time Furnace Offer – Don’t Wait!</h2>
...
export default SecondaryHeroFurnace;