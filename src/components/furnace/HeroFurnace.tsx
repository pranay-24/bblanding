...
const HeroFurnace: React.FC<HeroProps> = ({ contactFormEmbed }) => {
  ...
  const carouselImages = [
    {
      url: '/man-installs-furnace.webp',
      title: '$500 Off on a New Furnace System Installation',
      subTitle: 'Get your free estimate by filling up the form.',
      subTitle2: 'A limited-time offer from most trusted HVAC & plumbing experts.'
    },
  ];
